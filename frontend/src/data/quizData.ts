...
export const quizData: QuizData[] = [
  {
    ...
    options: ["一来果", "予流果", "不還果", "阿羅漢果"], //[Options[0]を正解とするように変更
  ...
  },
  {
    ...
    options: ["苦しみをなくす", "儀式儀礼を行う", "信じる者は救われる", "現世利益を得る"],
